...
RSpec.describe 'stamina calculator (stamina) with params' do
  context 'when recover_stamina_seconds=80' do
    it 'default value is 80.0' do
      visit stamina_tools_stamina_calculator_path(recover_stamina_seconds: 80)
  ...
  context 'when recover_stamina_seconds=50.50' do
    it 'default value is 50.50' do
      visit stamina_tools_stamina_calculator_path(recover_stamina_seconds: 50.50)
  ...
  context 'when recover_stamina_seconds=-10' do
    it 'default value is -10' do
      visit stamina_tools_stamina_calculator_path(recover_stamina_seconds: -10)
